 ...
 *           retirando os coment‡rios @Test dos mŽtodos. 
 *  
 */
public class BankingTest {
	...
	/**
	 * Teste para testar emprŽstimos acima do permitido
	 */
	...
	@Test (expected= InsufficientBalanceException.class) public void safetyBalanceRule() throws InsufficientBalanceException {
		...
		// sinaliza InsufficientBalanceException ja que n‹o h‡ saldo de emprŽstimo e o limite de seguran�a Ž 100,00 		
